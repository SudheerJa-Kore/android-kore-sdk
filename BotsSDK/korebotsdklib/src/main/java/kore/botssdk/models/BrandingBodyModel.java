...
public class BrandingBodyModel implements Serializable {
    ...
    private BrandingBodyTypingIndicatorModel typing_indicator;
    ...
    public BrandingBodyModel updateWith(BrandingBodyModel configModel) {
        ...
        typing_indicator = configModel.typing_indicator != null
                ? typing_indicator != null
                        ? typing_indicator.updateWith(configModel.typing_indicator)
                        : configModel.typing_indicator
                : typing_indicator;
    ...
    public BrandingBodyTypingIndicatorModel getTyping_indicator() {
    ...
    public void setTyping_indicator(
            BrandingBodyTypingIndicatorModel typing_indicator
    ) {
        this.typing_indicator = typing_indicator;
    }
