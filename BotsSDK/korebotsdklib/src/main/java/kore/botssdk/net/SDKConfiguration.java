...
public class SDKConfiguration {
    ...
    public static class OverrideKoreConfig {
        public static Integer androidChatScreenPercentage = null;
        public static Integer chatScreenPercentage = null;
        public static int chatWindowHeightPercentage = 90;

        public static int getResolvedChatScreenPercentage() {
            Integer requestedPercentage =
                    androidChatScreenPercentage != null
                            ? androidChatScreenPercentage
        ...
        public static boolean showTextToSpeech = false;
