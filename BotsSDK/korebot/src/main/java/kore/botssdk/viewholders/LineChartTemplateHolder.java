...
public class LineChartTemplateHolder extends BaseViewHolder implements OnChartGestureListener {
    ...
    public void bind(BaseBotMessage baseBotMessage) {
        ...
        int[] lineColors = createOpacityPalette(userBubbleColor, lineList.size());
        ...
        for (int baseIndex = 0; baseIndex < lineList.size(); baseIndex++) {
            ...
            dataSet[baseIndex].setColor(lineColors[baseIndex]);
            dataSet[baseIndex].setCircleColor(lineColors[baseIndex]);
            ...
            dataSet[baseIndex].setValueTextColor(chartTextColor);
            dataSet[baseIndex].setDrawFilled(true);
            dataSet[baseIndex].setFillColor(Color.rgb(
                    Color.red(lineColors[baseIndex]),
                    Color.green(lineColors[baseIndex]),
                    Color.blue(lineColors[baseIndex])));
            dataSet[baseIndex].setFillAlpha(Color.alpha(lineColors[baseIndex]));
        ...
        lineChart.getXAxis().setTextColor(chartTextColor);
        lineChart.getXAxis().setAxisLineColor(chartTextColor);
        lineChart.getAxisLeft().setTextColor(chartTextColor);
        lineChart.getAxisLeft().setAxisLineColor(chartTextColor);
    ...
    private int[] createOpacityPalette(int baseColor, int size) {
