...
public class ButtonTemplateHolder extends BaseViewHolder {
    ...
    public void bind(BaseBotMessage baseBotMessage) {
        ...
        if (botButtonModels != null && !botButtonModels.isEmpty()) {
            ...
            ButtonTemplateAdapter buttonTypeAdapter = new ButtonTemplateAdapter(
                    buttonsList.getContext(),
                    botButtonModels,
                    isLastItem(),
                    payloadInner.isFullWidth(),
                    payloadInner.isStackedButtons(),
                    payloadInner.getVariation()
            );
            buttonTypeAdapter.setMsgId(((BotResponse) baseBotMessage).getMessageId());
            buttonTypeAdapter.setContentStateListener(contentStateListener);
            buttonTypeAdapter.setSelectedIndex(selectedIndex);
