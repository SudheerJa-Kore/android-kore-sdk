...
public class BotChatFragment extends Fragment implements BotChatViewListener, ComposeFooterInterface, TTSUpdate, InvokeGenericWebViewInterface {
    ...
    private void applyBotLanguageIfNeeded(BotResponse botResponse) {
        ...
        if (rlChatWindow != null) {
            rlChatWindow.setLayoutDirection(layoutDirection);
        }
        ...
        refreshHeaderLanguageDirection(getChildFragmentManager());
    }
    ...
    private String getPreferredString(int stringResource) {
