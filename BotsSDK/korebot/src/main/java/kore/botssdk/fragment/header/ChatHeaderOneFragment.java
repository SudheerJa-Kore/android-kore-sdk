...
public class ChatHeaderOneFragment extends BaseHeaderFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.bot_header, container, false);
        ...
        if (brandingHeaderModel != null) {
            ...
            if (brandingHeaderModel.getIcon() != null) {
                if (BundleUtils.CUSTOM.equals(brandingHeaderModel.getIcon().getType())) {
                    ...
                    LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams((int) (46 * dp1), (int) (46 * dp1));
        ...
        tvBotDesc.setText(getOnlineStatusText());
        tvBotDesc.setTextColor(Color.parseColor("#176B4A"));
